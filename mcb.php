...
<body>
    ...
    <div class="main_btns">
        <div class="form">
            <button pdf_img="print-button" name="MCB_maint_btn" id="MCB_maint" onclick="maint_MCB_Page"><img class="pdf_img" src="imgs/maint2.png" alt=""><br> .أجراء الفحص </button>
            <button pdf_img="print-button" name="MCB_btn" id="MCB_Show" onclick="show_MCB_page"><img class="pdf_img" src="imgs/tableshowimg2.png" alt=""><br> .عرض وطباعة</button>
