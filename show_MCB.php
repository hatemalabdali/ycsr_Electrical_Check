                    ...
                    if ($table_exists && $table_exists->num_rows > 0) {
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_assoc()) {
                                // تحويل الرمز المخزن في قاعدة البيانات إلى نص للعرض
                                $status_text = '';
                                $status_class = '';
                                if ($row['STATUS'] === '✅') {
                                    $status_text = 'OK';
                                ...
                                echo "<td class='editable status-cell $status_class' data-column='STATUS' data-id='" . htmlspecialchars($row['SR.NO.']) . "'>" . htmlspecialchars($status_text) . "</td>";
