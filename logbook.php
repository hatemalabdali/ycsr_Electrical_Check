...
<head>
  ...
  <title>القرائات اليومية والتقارير</title>
  <style>
...
<body>
  ...
  <div class="page_label">
    <h1>القرائات اليومية والتقارير</h1>
    <hr>
  ...
  <div class="main_btns">
    <div class="form">
      <button id="logbook_record"><img class="pdf_img" src="imgs/maint2.png" alt=""><br>تسجيل القرائات</button>
      <button id="logbook_show"><img class="pdf_img" src="imgs/tableshowimg2.png" alt=""><br>عرض وطباعة</button>
