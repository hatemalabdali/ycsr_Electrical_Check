...
<body>
  ...
  <div class="main_btns">
    ...
    <div class="form">
      ...
      <button id="maintenance_motors_table"><img class="pdf_img" src="imgs/maint2.png" alt=""><br>..اجراء الفحص</button>

      <button id="print_motors_table"><img class="pdf_img" src="imgs/tableshowimg2.png" alt=""><br>..عرض وطباعة</button>



      <!-- <button onclick="back_to_main_page" id="btn_frm_motors_to_main">تراجع</button> -->

      <button class="print-button" name="btnback" id="btn_frm_motors_to_main" onclick="back_to_main_page"><img class="pdf_img" src="imgs/exit.png" alt=""><br> .. خروج</button>
