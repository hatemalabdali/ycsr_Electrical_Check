...
<head>
  ...
  <title>الفحص اليومي للمحولات</title>
  <style>
    ...
    .form form {
      display: contents; /* هذا يجعل العنصر form شفافاً للتخطيط */
    }
    ...
    .form button {
      ...
      justify-content: center;
      min-height: 140px;
      width: 100%; /* للتأكد من أن كل الأزرار بنفس العرض */
    }
...
<body>
  ...
  <div class="main_btns">
    <div class="form">
      <button id="maintenance_transformer_table"><img class="pdf_img" src="imgs/maint2.png" alt=""><br>اجراء الفحص</button>
      <button id="print_transformer_table"><img class="pdf_img" src="imgs/tableshowimg2.png" alt=""><br>عرض وطباعة</button>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const month = now.toLocaleDateString('ar-AR', { month: 'long' });
  ...
  ?>
  <img src="imgs/transformerimg2.png" alt="">
</body>
</html>