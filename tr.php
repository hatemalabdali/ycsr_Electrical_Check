...
<body>
    ...
    <div class="main_btns">
        <div class="form">
            <button id="tr_Maint"><img class="pdf_img" src="imgs/maint2.png" alt=""><br>اجراء الفحص</button>
            <button id="tr_Show"><img class="pdf_img" src="imgs/tableshowimg2.png" alt=""><br>عرض وطباعة</button>
